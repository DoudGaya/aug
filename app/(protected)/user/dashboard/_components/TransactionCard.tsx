       ...
       <small className="  text-xs font-semibold "> ({ transaction.date.toDateString() }) </small>
        ...
        <CardContent>
         ...
         <Dialog>
            ...
            <CardFooter className=" bg-yellow-400 w-full rounded-b-lg pb-2 font-semibold cursor-pointer flex items-center justify-center text-center my-auto align-middle">
              <p className="font-poppins py-1 text-yellow-10">Update Transaction</p>
            </CardFooter>
            </DialogTrigger>
